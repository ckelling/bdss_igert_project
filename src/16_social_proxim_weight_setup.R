...
###
### Created 1/29/18 for new social proximity setup and modeling, not binary
### 
...
load(file = "C:/Users/ckell/OneDrive/Penn State/Research/bdss_igert_project/data/final/agg_crime_dat.Rdata")
#   shape file
...
load(file = "C:/Users/ckell/OneDrive/Penn State/Research/bdss_igert_project/data/working/subs_lodes.Rdata")
